    ...
    <div class="right-menu">
      <el-dropdown placement="bottom-start" class="avatar-container" trigger="click">
        <div class="avatar-wrapper">
          <svg t="1600311663297"   style="color: #fff" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="5329" width="35" height="40">
            <path
...
export default {
  ...
  created () {
    ...
    this.name = JSON.parse(sessionStorage.getItem("UserInfo")).AccountName
  },
  methods: {
    // 点击侧边栏对应面包屑
    clickMenu (item) {
      ...
      this.$refs["ruleForm"].validate(async (valid) => {
        if (valid) {
          ...
          const data = {
            ...
            AccountPassword:that.ruleForm.newPassword,
